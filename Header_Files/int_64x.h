...
//6. Add a function that returns the decimal part of int_64x division as a float
...
public:
	...
	int_64x& operator<<=(const unsigned int left_shift); //TODO: When left shifting by 64, unexpected things are happening, make it so shifting by 64 can't happen
